...
<div id="services-kayaking" class="modal fade" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" >
            ...
            <p class="text-muted"><b>Cjelodnevni izlet biciklom</b> počine u 9 h Izlet biciklom dogovara se barem jedan dan unaprijed. Izlet počinje i završava u Premanturi blizu kućnog broja selo 63 (nasuprot Surf bara). Tijekom cjelodnevnog izleta ćemo vidjeti i proći biciklističku stazu na donjem Kamenjaku, zaustaviti se i pogledati dino park i vidjeti otiske dinosaurusa. Okupatise na osamljenim plažama. Proći singl trailove na Gornjem Kamenjaku. Ručak u Safari baru. O ritmu odvijanja izleta odlučuje vodič, na način da se odvijanje izleta provodi na siguran način i onim tempom koji mogu pratiti svi sudionici izleta. Prijeći ćemo oko 30 km
            <br>
            <br>
            <b>TRAJANJE:</b> oko 8h.
            <br>
            ...
            <ul class="list-group">
              <li class="list-group-item">Vodiča</li>
              <li class="list-group-item">Biciklu</li>
              <li class="list-group-item">Voće i vodu</li>
              <li class="list-group-item">Ručak</li>
              <li class="list-group-item">Sigurnosnu opremu</li>
            </ul> 
...
<!-- <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
  ...
  <!-- </div> -->
      ...
      <div class="pmd-card-actions col-xs-6">
        <a class="facebook-modal-link btn-success btn" href="https://www.facebook.com/RENT-A-BIKE-Premantura-917457535047303/?__tn__=%2Cd%2CP-R&eid=ARB9kySoM_K-mo2UVIkjqMdzVsTRRAfYFHfSYqX1ZL_4bnwLixSzDLym9Kp71DZl4mBHLLYInYMTtouZ" target="_blank"><span class="fa fa-facebook">POSJETITE NAS</span></a>
     </div> 
