<div class="container-fluid no-padding" id="onama">
    ...
    <div class="row text-center">
        <div class="col-sm-6 col-md-6 onama-front col-lg-4">
            <h3>OUR TEAM</h3>
            <?php include "php/team-slide.php" ?>
        </div>
        <div class="col-sm-6 d visible-sm visible-xs visible-md  onama-front">
            <h3>ABOUT US</h3>
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 onama-front">
            <h3>PROMO VIDEO</h3>
            <div class="embed-responsive embed-responsive-16by9 card-2">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/ryJQj2V_jw8?controls=0"
                    frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
            </div>
        </div>

        <div class="col-sm-6 visible-lg hidden-md  hidden-sm hiden-xs col-lg-4 onama-front">
            <h3>ABOUT US</h3>
            <p class=" text-justify text-muted">
                <strong>Boat Excursions Tonka</strong> is a family run company providing boat services, excursions and
                transfers on the sea in Rovinj, Croatia. <br>
                We are operating with 2 boats: the “Tonka” wooden motor boat with capacity of 46 persons and the
                speedboat “Tonka” for 12 persons. <br>
                We are located in Rovinj's northern port "Valdibora" and in the tourist resort "Vilas Rubin"
            </p>
            ...
            <p class="text-muted text-justify" id="showtext2">
                Enio (captain, skipper and owner) will make sure that you enjoy the beautiful scenery of the Rovinj
                Archipelago. Marija (mum, cook and ticket seller) prepares our delicious meals and snacks. Lara (sister)
                and Ville (the finnish half of the family) take care of internet booking, social media and excursions
                with the speedboat "Tonka".
         ...
         <br><br>
            <div class="text-center">
                <button id="morebtn2" class="badge"> More <span class="fa fa-sort-desc"></span></button> <button
                    id="morebtn-hide2" class="badge"> Less <span class="fa fa-sort-up"></span></button>
            </div>
        </div>
